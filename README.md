...
For MP4 output, Snagger asks yt-dlp for H.264/AVC video with AAC audio in an MP4 container. That avoids YouTube's AV1 (`av01`) MP4 streams, which some editors such as Adobe Premiere may reject.
